            ...
            ui.querySelector('.button-angle').onclick = () => {
                ...
                if (ui.querySelector('.fanbox').classList.contains('active')) {
                    ...
                    if (!b.classList.contains('loading')) {
                        ...
                        hass.callService('xiaomi_miio_airpurifier', 'fan_set_oscillation_angle', {
                            entity_id: entityId,
                            angle: newAngle
                        });
                    }
            ...
            ui.querySelector('.button-timer').onclick = () => {
                ...
                if (ui.querySelector('.fanbox').classList.contains('active')) {
                    ...
                    if (!b.classList.contains('loading')) {
                        ...
                        hass.callService('xiaomi_miio_airpurifier', 'fan_set_delay_off', {
                            entity_id: entityId,
                ...
                if (ui.querySelector('.fanbox').classList.contains('active')) {
                    ...
                    if (!b.classList.contains('loading')) {
                        ...
                        if (oldChildLockState === 'On') {
                            ...
                            hass.callService('xiaomi_miio_airpurifier', 'fan_set_child_lock_off')
                            u.innerHTML = 'Off'
                        } else if (oldChildLockState === 'Off') {
                            this.log(`Set child lock to: On`)
                            hass.callService('xiaomi_miio_airpurifier', 'fan_set_child_lock_on')
                            u.innerHTML = 'On'
                        } else {
            ...
            ui.querySelector('.var-natural').onclick = () => {
                ...
                if (ui.querySelector('.fanbox').classList.contains('active')) {
                    ...
                    if (u.classList.contains('active') === false) {
                        ...
                        hass.callService('xiaomi_miio_airpurifier', 'fan_set_natural_mode_on', {
                            entity_id: entityId
                        });
                    } else {
                        this.log(`Set natural mode to: Off`)
                        u.classList.remove('active')
                        hass.callService('xiaomi_miio_airpurifier', 'fan_set_natural_mode_off', {
                            entity_id: entityId
                        });
                    }
                }
